...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	...
	/**
	 * V1:bean的作用范围,对应bean属性scope
	 */
	@Nullable
	private String scope = SCOPE_DEFAULT;
	/**
	 * V1:是否是抽象，对应bean属性abstract
	 */
	private boolean abstractFlag = false;

	/**
	 *  V1:是否延迟加载,对应bean属性lazy-init
	 */
	@Nullable
	...
	/**
	 * V1:依赖检查，Spring 3.0后弃用这个属性
	 */
	private int dependencyCheck = DEPENDENCY_CHECK_NONE;
	/**
	 * V1:用来表示一个bean的实例化依靠另一个bean先实例化,对应bean属性depend-on
	 */
	@Nullable
	private String[] dependsOn;
	/**
	 * V1:autowire-candidate属性设置为false，这样容器在查找自动装配对象时，
	...
	/**
	 * V1:自动装配时当出现多个bean候选者时，将作为首选者,对应bean属性primary
	 */
	private boolean primary = false;

	/**
	 * V1:用于记录Qualifier，对应子元素qualifier
	 */
	...
	/**
	 * V1:允许访问非公开的构造器和方法，程序设置
	 */
	private boolean nonPublicAccessAllowed = true;
	/**
	 * V1:是否以一种宽松的模式解析构造函数，默认为true,
	 * 如果为false,则在如下情况
	 * interface ITest{}
	...
	/**
	 * V1:对应bean属性factory-method
	 */
	@Nullable
	private String factoryMethodName;

	/**
	 * V1:记录构造函数注入属性，对应bean属性constructor-arg
	 */
	@Nullable
	...
	/**
	 * V1:方法重写的持有者 ,记录lookup-method、replaced-method元素
	 */
	private MethodOverrides methodOverrides = new MethodOverrides();

	/**
	 * V1:初始化方法，对应bean属性init-method
	 */
	@Nullable
	private String initMethodName;

	/**
	 * V1:销毁方法，对应bean属性destory-method
	 */
	@Nullable
	private String destroyMethodName;

	/**
	 * V1:是否执行init-method，程序设置
	 */
	private boolean enforceInitMethod = true;

	/**
	 * V1:是否执行destory-method，程序设置
	 */
	private boolean enforceDestroyMethod = true;

	/**
	 * V1:是否是用户定义的而不是应用程序本身定义的,创建AOP时候为true，程序设置
	 */
	 ...
	 * V1:定义这个bean的应用
	 * 0：APPLICATION：用户，
	 * 1：INFRASTRUCTURE：完全内部使用，与用户无关，
	 * 2：SUPPORT：某些复杂配置的一部分程序设置
	 */
